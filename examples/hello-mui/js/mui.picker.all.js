...
(function($, document) {
	...
	var PopPicker = $.PopPicker = $.Class.extend({
		...
		show: function(callback) {
			...
			self.mask.show();
			document.body.classList.add('mui-poppicker-active-for-page');
			self.panel.classList.add('mui-active');
			//处理物理返回键
			self.__back = $.back;
			$.back = function() {
				self.hide();
		...
		hide: function() {
			...
			self.panel.classList.remove('mui-active');
			self.mask.close();
			document.body.classList.remove('mui-poppicker-active-for-page');
			//处理物理返回键
			$.back=self.__back;
		},
		dispose: function() {
