		...
		mui.plusReady(function() {
			...
			mui.ajax(apiUrl + 'Usersint/int_bank_permit', {
				...
				success: function(data) {
					...
					document.getElementById('gong-zi-info').innerHTML ="积分总额：" + (data.data.total_already_int ? data.data.total_already_int : "0") + '<p class="mui-ellipsis">可用积分：' + (data.data.already_int ? data.data.already_int : "0") + "</p>"
