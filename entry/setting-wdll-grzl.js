			...
			mui.ajax(apiUrl +  'app/get_users_info', {
					...
					success: function(data) {
						...
						if(data.status == 1 && data.data!="") {
							...
							document.getElementById('xue-li').innerHTML = data.data.xue_li;
							document.getElementById('hu-ji-xing-zhi').innerHTML = data.data.hu_ji_xing_zhi;
							document.getElementById('hun-yin-zhuang-kuang').innerHTML = data.data.hun_yin_zhuang_kuang;
...
//				}
//				mui.openWindow({
//					url: 'setting-wdll-grzl-add.html',
//					id: 'setting-wdll-grzl-add',
//					createNew: true,
//					show: {
//						autoShow: true,
