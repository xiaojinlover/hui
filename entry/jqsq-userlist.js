			...
			var usersIdArray = [];
				...
				mui.each(mui('input[type="checkbox"]'),function(index,item){
					if(item.checked){
						...
						openerHtml += '<div class="image-item" ><div class="image-close" data-form="' + forms + '" data-type="' + shenHeType + '" data-usersid="' + this.parentNode.getAttribute('data-usersid') + '">X</div><img class="file" src="' + this.parentNode.getAttribute('data-usersimage') + '"><p class="name">' + this.parentNode.getAttribute('data-realname') + '</p></div>'
